...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final disabledDay = DateTime(2023, DateTime.april, 14);
  ...
  Widget _buildDefaultSingleDatePickerWithValue() {
    final config = CalendarDatePicker2Config(
        ...
        selectableDayPredicate: (DateTime day) {
          ...
          // print(DateFormat().add_yMd().format(day));
          // print(DateFormat().add_yMd().format(day));
          if (dayDate.isBefore(DateTime.now().subtract(Duration(days: 1))) ||
              dayDate == disabledDay) {
            return false;
          } else {
            return true;
      ...
      children: [
        ...
        CalendarDatePicker2(
          ...
          onValueChanged: (dates) => {
            if (dates.length == 2)
              {
                if (disabledDay.isAfter(dates.first!) &&
                    disabledDay.isBefore(dates.last!))
                  {print('No way')}
              },
